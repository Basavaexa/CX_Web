...
public class AssignTaskForAldarEducation 
{

	public WebDriver driver;
	public AssignTaskForAldarEducation(WebDriver driver1)
	{
		driver=driver1;
	...
	public void click_and_Select_Assets_AE() throws InterruptedException 
	{
		...
		driver.findElement(By.xpath("//span[text()='Aldar Education']")).click();
	}
	...
	public void click_and_Select_Location() throws InterruptedException 
	{
		...
		driver.findElement(By.xpath("//span[text()='Al Yasmina Academy']")).click();
	}
